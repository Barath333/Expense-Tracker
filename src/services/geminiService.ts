...
// // For now, replace with your actual key
// // Later, move this to environment variables
// const GEMINI_API_KEY = 'AIzaSyDKYD9Mkqj8OmYYqOQImhrsnemXQIMHjpY'; // ← Replace this!
...
//     Example insights:
//     - If high food delivery: "🍔 Your Swiggy/Zomato spend is ₹X. Try cooking 2 meals at home to save ₹Y this month."
//     - If budget on track: "🎯 Great job! You're ₹X under budget. Consider saving or investing the extra amount."
//     - If overspending: "⚠️ You're ₹X over budget on ${topCategory}. Here's how to get back on track..."
...
//       body: `${topCategory[0]} is your top category at ₹${topCategory[1].toLocaleString('en-IN')}. Consider setting a budget cap.`,
//       action: `View ${topCategory[0]} expenses`
//     });
//   }
...
//       body: `You've spent ${Math.round(percentage)}% of your ₹${monthlyBudget.toLocaleString('en-IN')} budget.`,
...
//   insights.push({
//     title: 'Pro Tip 💡',
//     body: 'Regular expense tracking helps you save 20-30% more. Keep going!',
...
const GEMINI_API_KEY = 'AIzaSyDKYD9Mkqj8OmYYqOQImhrsnemXQIMHjpY';
